/*************************************************************
  ...
  Develop a basic W3.CSS interface.
    ...
    v22   Replace DB button with BG button to stop confusion
    ...
    v24   Replace BG with BG to stop confusion
...
const BG      = 'leaderboard/BG';                                            //<=======
const SI      = 'leaderboard/RGNG';                                            //<=======
...
const AD_BTN_BG   = document.getElementById("b_ad_BG");
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  ad_user();
    console.log('Button elements:', { AD_BTN_USER, AD_BTN_BG, AD_BTN_SI });
});
...
/**************************************************************/
// ad_BG()
// Input event; called when admin's BG button clicked
// Display BG (Bouncing Ball) admin screen
// Input:  n/a
// Return: n/a
/**************************************************************/
export function ad_BG() {
  console.log('%c ad_BG(): ',
              'color: ' + AD_COL_C + '; background-color: ' + AD_COL_B + ';');

  ad_alterClass('ad_btn', 'grey');
 // document.getElementById("b_ad_BG").style.backgroundColor   = "cyan";
  ad_readAll(BG, null, ad_processBGReadAll);                            //<=======           
}
...
/**************************************************************/
// ad_processBGReadAll(_result, _path,  _snapshot, _save, _error)
// Called by ad_readAll() to handle result of read ALL BG records request.
// Save data & update display with record info
// Input:  result('waiting', 'OK', 'error'), path, 
//         snapshot, where to save it & error msg if any
//         NOTE: This is the raw data, EG snapshot, and
...
/**************************************************************/
//                 _procFunc(_result, _path, _snapshot, _save, _error)
function ad_processBGReadAll(_result, _path, _snapshot, _save, _error) {
  console.log('%c ad_processBGReadAll(): result= ' + _result, 
              'color: ' + AD_COL_C + '; background-color: ' + AD_COL_B + ';');
